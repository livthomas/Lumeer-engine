...
public class DocumentFacade extends AbstractFacade {
   ...
   public Document createDocument(String collectionCode, Document document) {
      ...
      DataDocument storedData = createData(collection.getId(), storedDocument.getId(), document.getData());
   ...
   private DataDocument createData(String collectionId, String documentId, DataDocument data) {
      data.setId(documentId);
      return dataDao.createData(collectionId, data);
   }
