...
@Indexes({
      ...
      @Index(fields = { @Field(MorphiaCollection.ATTRIBUTES + "." + MongoAttribute.NAME) }),
      @Index(fields = {
            @Field(value = MorphiaCollection.CODE, type = IndexType.TEXT),
            @Field(value = MorphiaCollection.NAME, type = IndexType.TEXT),
            @Field(value = MorphiaCollection.ATTRIBUTES + "." + MongoAttribute.NAME, type = IndexType.TEXT)
      })
})
public class MorphiaCollection extends MorphiaResource implements Collection {
   ...
   @Embedded(ATTRIBUTES)
   private List<MongoAttribute> attributes;
   ...
   public MorphiaCollection(Collection collection) {
      ...
      this.attributes = MongoAttribute.convert(collection.getAttributes());
   ...
   public void setAttributes(final List<Attribute> attributes) {
      this.attributes = MongoAttribute.convert(attributes);
   }
